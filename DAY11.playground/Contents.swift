...
//First, here’s a protocol called Identifiable1 that requires any conforming type to have an id property and an identify() method:
...
let sandeep = User1(id: "Sandeep007")
sandeep.identify()
